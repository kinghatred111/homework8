...
def main():  # основной модуль с которого начинает работу программа
    while True:  # бесконечный цикл, в котором ожидаем реакции с консоли
        ...
        if command == "q":
            ...
            source_file = input("Укажите файл с которого надо перенести строку: ")
            if not exists(source_file):
                print("Файл не существует.")
            continue
            destination_file = input("Укажите файл в который нужно перенести строку: ")
            if not exists(destination_file):
                print("Файл не существует.")
            continue
            line_number_to_read = int(input("Укажите номер строки для копирования:  "))
            line_number_to_replace = int(input("Укажите номер строки для замены:  "))
